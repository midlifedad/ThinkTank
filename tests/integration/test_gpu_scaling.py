...
async def test_scale_up_when_queue_exceeds_threshold(mock_get_replicas, mock_scale, session):
...
@patch("thinktank.scaling.railway.scale_gpu_service", new_callable=AsyncMock)
@patch("thinktank.scaling.railway.get_gpu_replica_count", new_callable=AsyncMock)
async def test_no_scale_when_queue_below_threshold(mock_get_replicas, mock_scale, session):
...
@patch("thinktank.scaling.railway.scale_gpu_service", new_callable=AsyncMock)
@patch("thinktank.scaling.railway.get_gpu_replica_count", new_callable=AsyncMock)
async def test_scale_down_after_idle_timeout(mock_get_replicas, mock_scale, session):
...
@patch("thinktank.scaling.railway.scale_gpu_service", new_callable=AsyncMock)
@patch("thinktank.scaling.railway.get_gpu_replica_count", new_callable=AsyncMock)
async def test_no_scale_down_when_idle_under_timeout(mock_get_replicas, mock_scale, session):
...
@patch("thinktank.scaling.railway.scale_gpu_service", new_callable=AsyncMock)
@patch("thinktank.scaling.railway.get_gpu_replica_count", new_callable=AsyncMock)
async def test_idle_timer_starts_when_queue_empty(mock_get_replicas, mock_scale, session):
...
@patch("thinktank.scaling.railway.scale_gpu_service", new_callable=AsyncMock)
@patch("thinktank.scaling.railway.get_gpu_replica_count", new_callable=AsyncMock)
async def test_idle_timer_resets_when_queue_has_jobs(mock_get_replicas, mock_scale, session):
