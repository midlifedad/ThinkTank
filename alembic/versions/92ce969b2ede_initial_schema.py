...
def upgrade() -> None:
    ...
    op.create_table('candidate_thinkers',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('name', sa.Text(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['llm_review_id'], ['llm_reviews.id'], ),
    ...
    op.create_table('thinker_categories',
    sa.Column('thinker_id', sa.Uuid(), nullable=False),
    ...
    op.create_table('thinker_metrics',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('thinker_id', sa.Uuid(), nullable=False),
    ...
    op.create_table('thinker_profiles',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('thinker_id', sa.Uuid(), nullable=False),
    sa.Column('education', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=False),
    sa.Column('positions_held', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=False),
    sa.Column('notable_works', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=False),
    sa.Column('awards', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('NOW()'), nullable=False),
    sa.ForeignKeyConstraint(['thinker_id'], ['thinkers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['source_owner_id'], ['thinkers.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('canonical_url'),
    sa.UniqueConstraint('content_fingerprint')
    )
    op.create_table('content_thinkers',
